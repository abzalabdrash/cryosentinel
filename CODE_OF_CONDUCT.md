...
Instances of abusive, harassing, or otherwise unacceptable behaviour may be reported to the project maintainer through the GitHub profile listed in the project README. Security-sensitive reports should use the private vulnerability reporting flow described in `SECURITY.md`. All complaints will be reviewed and investigated promptly and fairly.
...
**Consequence**: A private, written warning from maintainers, providing clarity around the nature of the violation and an explanation of why the behaviour was inappropriate.
